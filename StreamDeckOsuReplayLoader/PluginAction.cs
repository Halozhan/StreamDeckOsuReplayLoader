...
namespace streamdeckosureplayloader
{
    ...
    public class PluginAction : PluginBase
    {
        ...
        {
            //ref: https://stackoverflow.com/questions/20482338/simulate-keyboard-input-in-c-sharp
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();

            Input.type = 1; // 1 = Keyboard Input
            Input.U.ki.wScan = ScanCodeShort.F2;
            //Input.U.ki.wVk = VirtualKeyShort.F2;
            Input.U.ki.dwFlags = KEYEVENTF.SCANCODE;
            //Input.U.ki.dwFlags = KEYEVENTF;
            Inputs[0] = Input;
        ...
        private void RecentReplayLoader()
        {
